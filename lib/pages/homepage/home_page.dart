...
class _HomePageState extends State<HomePage> {
  TrackerWidgetController _trackerWidgetController =
      Get.put(TrackerWidgetController());

  FirebaseOperations _firebaseOperations = FirebaseOperations();
  RecordsPageController recordsPageController =
      ...
      body: Obx(() {
        return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return TrackerWidgetBuilder(
                  title: _trackerWidgetController.trackers[index],
                  index: index);
            });
      }),
    ));
